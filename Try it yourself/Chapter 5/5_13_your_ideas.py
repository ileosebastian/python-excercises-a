...
"""
	- A game about medieval knights
	- A trivial game to education-oriented.
	- Algorithms that could be optimized for a better experience
	- A web site for my dad's business
"""